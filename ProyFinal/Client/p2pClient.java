...
public class p2pClient {
	...
	public static void main(String args[]) throws Exception {
			...
			System.setSecurityManager(new SecurityManager());
                ...
                try{
                        ...
                        if(IndexServer.getPeer(p.Id)!=null){
                            System.out.println("Atencion: peerId ya existe. Selecciona otro peerId");
                            System.exit(0);
                        }
		...
		System.out.println("Cliente corriendo ... \""+"rmi://"+p.host+":" + p.port + "/"+instanceName+"\"");//muestra la direccion de la instancia
